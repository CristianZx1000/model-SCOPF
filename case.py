...
def get_scenarios_data(app, prj):
    ...
    gen_bus_AGC = {
        ...
        "Unidad Nº 5 Caterpillar.ElmSym": {"bus": 2,  "vf": 0, "cost":[cdn*23.389, 0], "Cto_up": 0,                     "Cto_dn": 0},
        "Unidad Nº 7 Solar Titan.ElmSym": {"bus": 1,  "vf": 1, "cost":[cdn*9.819, 0],  "Cto_up": u_term * 9.819,        "Cto_dn": u_term * 9.819},
        "Unidad Nº 8 GE10.ElmSym":        {"bus": 1,  "vf": 0, "cost":[cdn*20.137, 0], "Cto_up": 0,                     "Cto_dn": 0},
        "Unidad Nº 9 Solar Titan.ElmSym": {"bus": 1,  "vf": 1, "cost":[cdn*9.819, 0],  "Cto_up": u_term * 9.819 + 1e-6, "Cto_dn": u_term * 9.819 + 1e-6},
