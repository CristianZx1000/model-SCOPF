...
def get_scenarios_data(app, prj):
    ...
    # Traspasar costos a Dgs, también extraer tensiones de las barras desde DgS a través de un filtro (lista de nombres de los bus)

    # def. :    C.T.P. - Central Tres Puentes, C.P.A - Central Punta Arenas, P.C.N. - Planta Cabo Negro
    barras = {
            1:  {"name": "Celdas 11.5kV",               "Vbase": 11.5},
            2:  {"name": "Barra principal de 13.2kV_a", "Vbase": 13.2},
            3:  {"name": "Barra principal de 13.2kV_b", "Vbase": 13.2},
            4:  {"name": "C.T.P. 66kV",                 "Vbase": 66},
            5:  {"name": "C.P.A. 66kV",                 "Vbase": 66},
            6:  {"name": "Celdas G.E. 13.2kV",          "Vbase": 13.2},
            7:  {"name": "C.T.P. - 23 kV",              "Vbase": 23},
            8:  {"name": "P.C.N. ENAP",                 "Vbase": 23},
            9:  {"name": "PE VPatagónicos 23/CC",       "Vbase": 23},
            10: {"name": "WTG1",                        "Vbase": 23},
            11: {"name": "WTG1 0.65",                   "Vbase": 0.65},
            12: {"name": "WTG2",                        "Vbase": 23},
            13: {"name": "WTG3 0.65",                   "Vbase": 0.65},
            14: {"name": "WTG3",                        "Vbase": 23},
            15: {"name": "WTG3 0.65",                   "Vbase": 0.65},
            16: {"name": "Barra BT 400V UG N°10",       "Vbase": 0.4},
            17: {"name": "Barra BT 400V UG N°11",       "Vbase": 0.4},
            18: {"name": "Barra BT 400V UG N°12",       "Vbase": 0.4},
            19: {"name": "Barra BT 400V UG N°13",       "Vbase": 0.4},
            20: {"name": "Barra BT 400V UG N°14",       "Vbase": 0.4}
        }
    
    u_term = 1 #0.7 # funciona con valores mayores que 1, p. ej., 1.5, 2, etc.# casos individuales: C2 1.35; C4: 1.55
    u_wtg = 0.1 #0.1, 0.2, 0.4
    cdn = 1 # R_UP: C2: 0.5, C4: CL:0.35/SF:0.4, , all: 0.65, all-K_d: 0.35

    gen_bus_AGC = {
        # name, bus, vf_AGC, cost, Cto_up, Cto_dn 
        "Unidad Nº 4 Solar Mars.ElmSym":  {"bus": 1,  "vf": 1, "cost":[cdn*17.815, 0], "Cto_up": u_term * 17.815, "Cto_dn": u_term * 17.815},
        "Unidad Nº 5 Caterpillar.ElmSym": {"bus": 2,  "vf": 0, "cost":[23.389, 0], "Cto_up": 0,               "Cto_dn": 0},
        "Unidad Nº 7 Solar Titan.ElmSym": {"bus": 1,  "vf": 1, "cost":[cdn*9.819, 0],  "Cto_up": u_term * 9.819,  "Cto_dn": u_term * 9.819},
        "Unidad Nº 8 GE10.ElmSym":        {"bus": 1,  "vf": 0, "cost":[20.137, 0], "Cto_up": 0,               "Cto_dn": 0},
        "Unidad Nº 9 Solar Titan.ElmSym": {"bus": 1,  "vf": 1, "cost":[cdn*9.819, 0],  "Cto_up": u_term * 9.819,  "Cto_dn": u_term * 9.819},
        "UG N°10.ElmSym":                 {"bus": 16, "vf": 0, "cost":[31.4, 0],       "Cto_up": 0,               "Cto_dn": 0},
        "UG N°11.ElmSym":                 {"bus": 17, "vf": 0, "cost":[31.4, 0],       "Cto_up": 0,               "Cto_dn": 0},
        "UG N°12.ElmSym":                 {"bus": 18, "vf": 0, "cost":[31.4, 0],       "Cto_up": 0,               "Cto_dn": 0},
        "UG N°13.ElmSym":                 {"bus": 19, "vf": 0, "cost":[31.4, 0],       "Cto_up": 0,               "Cto_dn": 0},
        "UG N°14.ElmSym":                 {"bus": 20, "vf": 0, "cost":[31.4, 0],       "Cto_up": 0,               "Cto_dn": 0},
        "WTG1.ElmGenstat":                {"bus": 11, "vf": 1, "cost":[0, 0],          "Cto_up": u_wtg * 17.815,  "Cto_dn": u_wtg * 17.815},
        "WTG2.ElmGenstat":                {"bus": 13, "vf": 1, "cost":[0, 0],          "Cto_up": u_wtg * 17.815,  "Cto_dn": u_wtg * 17.815},
        "WTG3.ElmGenstat":                {"bus": 15, "vf": 1, "cost":[0, 0],          "Cto_up": u_wtg * 17.815,  "Cto_dn": u_wtg * 17.815}
    }
    ...
    for u in range(1, 7):
        ...
        if u == 1:
            ...
            for g in gens_sorted_sym:
                ...
                scenarios_data["sistema"]["generators_data"][name] = {
                    ...
                    "Cto_up": gen_info.get("Cto_up"),
                    "Cto_dn": gen_info.get("Cto_dn")
                }
        ...
        if u == 1:
            lineas_interes = [
                #from, to, kV
                ("Línea de unión en 66 kV.ElmLne", 4, 5, 66),
                ("Estructura 187-Central Tres Puentes.ElmLne", 7, 8, 23),
                ("PE VPatagónicos-Estructura 187_a.ElmLne", 7, 8, 23),
                ("Línea Subterránea.ElmLne", 8, 9, 23),
                ("PE VPatagónicos WTG1-PE VPatagónicos CC.ElmLne", 9, 10, 23),
                ("WTG1-WTG2.ElmLne", 10, 12, 23),
                ("WTG2-WTG3.ElmLne", 12, 14, 23)
            ]
...
def build_network_matrices(scenarios_data, baseMVA=100.0, eps_x=1e-9):
    ...
    # Diccionario para almacenar índices de líneas específicas
    line_indices = {}
    
    # Definir qué líneas te interesan (por conexión bus-bus)
    lineas_de_interes = {
        # name, from, to
        "line_4_5": (4, 5),      # Línea de unión en 66 kV
        "line_7_8": (7, 8),      # Equivalente 7-8 (reducido)
        "line_8_9": (8, 9),      # Línea Subterránea
        "line_9_10": (9, 10),    # PE VPatagónicos WTG1-PE VPatagónicos CC
        "line_10_12": (10, 12),  # WTG1-WTG2
        "line_12_14": (12, 14)   # WTG2-WTG3
    }
    
    # Buscar cada línea de interés
    for line_name, (fbus_target, tbus_target) in lineas_de_interes.items():
        for i, b in enumerate(branch_reduced):
            # Verificar conexión (puede ser en cualquier dirección)
            if {b["fbus"], b["tbus"]} == {fbus_target, tbus_target}:
                line_indices[line_name] = {
                    "index": i,           # Índice en la lista de branches
                    "fbus": b["fbus"],    # Bus from (1-indexed)
                    "tbus": b["tbus"],    # Bus to (1-indexed)
                    "name": b["name"]     # Nombre del branch
                }
                break
